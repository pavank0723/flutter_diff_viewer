...
### Added
- **Live Demo**: Deployed interactive demo to GitHub Pages at [pavank0723.github.io/flutter_diff_viewer](https://pavank0723.github.io/flutter_diff_viewer/)
- Added `documentation` and `homepage` links to `pubspec.yaml` pointing to the live demo
